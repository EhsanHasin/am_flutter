...
class _HomePageState extends State<HomePage> {
  ...
  rememberMeChecking()async{
    ...
    if(cbValue){
      Navigator.push(context, MaterialPageRoute(builder: (c){return SecondPage();}));
    }
  }
            ...
            children: [
              ...
              Visibility(
                visible: loaderVisibility,
                  child: Shimmer(child: Icon(Icons.downloading, size: 25, color: Colors.lightBlue,), gradient: LinearGradient(colors: [Colors.yellow, Colors.red])))
            ],
          ),
        ),
      ),
